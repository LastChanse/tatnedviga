...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('api', '0002_property_area_property_district'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='conversations', to='api.property')),
            ],
            options={
                'ordering': ['-updated_at'],
