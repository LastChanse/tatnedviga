    ...
    <div className="min-h-screen bg-white">
      ...
      <main className="mx-auto max-w-4xl px-4 py-8">
        ...
        <div className="grid gap-4 md:grid-cols-3 mb-6">
          ...
          <div className="p-4 bg-gray-100 rounded-xl border border-gray-200">
            <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Район / площадь</div>
            <div className="font-bold text-gray-900">{property.district || 'Район не указан'}{property.area ? ` · ${property.area} м²` : ''}</div>
          </div>
          <div className="p-4 bg-gray-100 rounded-xl border border-gray-200">
            <div className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-1">Опубликовано</div>
            <div className="font-bold text-gray-900 text-lg">{new Date(property.created_at).toLocaleDateString('ru-RU')}</div>
          </div>
        </div>
        ...
        <ViewingRequests propertyId={property.id} isOwner={localStorage.getItem("role") === "owner"} />
